...
def node0_trans():
	...
	for i in range (5):
		...
		result=ra.json()
		print("node 0 did trans a:", i , "result :",result['comp'])
		
		parameters={'recipient_node':i,'amount':10000}
		ra = requests.post(url='http://127.0.0.1:5000/create_transactiona',json=parameters)
		result=ra.json()
		print("node 0 did trans b:", i , "result :",result['comp'])
...
def node1_trans():
	...
	for i in range (5):
		...
		result=ra.json()
		print("node 1 did trans a:", i , " result :",result['comp'])
		
		parameters={'recipient_node':i,'amount':1000}
		ra = requests.post(url='http://127.0.0.2:5000/create_transactiona',json=parameters)
		result=ra.json()
		print("node 1 did trans b:", i , " result :",result['comp'])
...
def node2_trans():
	...
	for i in range (5):
		...
		result=ra.json()
		print("node 2 did trans a:", i , " result :",result['comp'])
		
		parameters={'recipient_node':i,'amount':1000}
		ra = requests.post(url='http://127.0.0.3:5000/create_transactiona',json=parameters)
		result=ra.json()
		print("node 2 did trans b:", i , " result :",result['comp'])
...
def node3_trans():
	...
	for i in range (5):
		...
		result=ra.json()
		print("node 3 did trans a:", i , " result :",result['comp'])
		
		parameters={'recipient_node':i,'amount':1000}
		ra = requests.post(url='http://127.0.0.4:5000/create_transactiona',json=parameters)
		result=ra.json()
		print("node 3 did trans b:", i , " result :",result['comp'])
...
def node4_trans():
	...
	for i in range (5):
		...
		result=ra.json()
		print("node 4 did trans a :", i , " result :",result['comp'])
		
		parameters={'recipient_node':i,'amount':1000}
		ra = requests.post(url='http://127.0.0.5:5000/create_transactiona',json=parameters)
		result=ra.json()
		print("node 4 did trans b :", i , " result :",result['comp'])
