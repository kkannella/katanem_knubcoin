...
if __name__ == '__main__':
	...
	if(ip=='127.0.0.1'):
		...
		new_node.current_block=gen_block
		...
		##make second block
		new_node.current_block=new_node.create_new_block(1,"") #using 1 as a random noncea to calculate hash of gen block
		...
		new_wallet=wallet.wallet(ip)
		new_node.wallet=new_wallet
		new_node.current_block=new_node.create_new_block(1,"")
		...
		start_new_thread(reg_th,(parameters,))
